...
|-------|--------|-------------|
| Renovacion Popular | 1 | AMPAY-002 (HIGH) |
...
> **Note:** AMPAY-006 and AMPAY-007 (Alianza para el Progreso, original pre-audit numbering) were removed during the manual audit due to incorrect vote interpretation. AMPAY-003 was retracted on 2026-07-09 because its supporting votes are procedural. Final traceability-audited total: 5 AMPAYs.
