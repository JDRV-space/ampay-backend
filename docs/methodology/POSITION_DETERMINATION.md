...
| File | Content |
|---|---|
| `scripts/legacy/aggregate_positions.py` | Historical position determination algorithm |
| `data/01_input/votes/party_positions.json` | Calculated positions by party and vote |
