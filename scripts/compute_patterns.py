...
def main():
    ...
    for party in TARGET_PARTY_SLUGS:
        party_data = {
            "by_category": {},
            "by_month": {},
            "category_averages": {}
    ...
    ensure_parent_dir(OUTPUT_PARTY_PATTERNS)

    print(f"Writing {OUTPUT_PARTY_PATTERNS}...")
    with open(OUTPUT_PARTY_PATTERNS, "w", encoding="utf-8") as f:
        json.dump(output, f, ensure_ascii=False, indent=2)

    # Stats
    file_size = OUTPUT_PARTY_PATTERNS.stat().st_size / 1024
